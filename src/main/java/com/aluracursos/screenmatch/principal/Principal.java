...
//        System.out.println(json);
    ...
    private void buscarEpisodioPorSerie() {
        mostrarSeriesBuscadas();
        System.out.println("Escribe el nombre de la serie para mostrar episodios ");
        var nombreSerie = teclado.nextLine();
        ...
        if (serie.isPresent()){
            ...
            for (int i = 1; i <= serieEncontrada.getTotalTemporadas(); i++) {
                var json = consumoApi.obtenerDatos(URL_BASE + API_KEY+ serieEncontrada.getTitulo().replace(" ", "+") + "&season=" + i);
...
//        datosSeries.add(datos);
    ...
    private void buscarSeriesPorCategoria() {
        System.out.println("Escriba el genero/categia de la serie que desea buscar: ");
    ...
    private void buscarSeriesPorTemporadaYEvaluacion() {
        System.out.println("Por cuantas temporadas desea filtrar?");
